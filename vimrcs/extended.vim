...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
map <leader>e :e! ~/MyVimrc/my_configs.vim<cr>
autocmd! bufwritepost ~/MyVimrc/my_configs.vim source ~/MyVimrc/my_configs.vim
...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
try
    set undodir=~/MyVimrc/temp_dirs/undodir
    set undofile
catch
endtry
